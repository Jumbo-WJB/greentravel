	...
	DateTimePicker.prototype = {
		...
		_modifyPicker: function()
		{
			...
			for(var iTempIndex = 0; iTempIndex < iNumberOfColumns; iTempIndex++)
			{
				...
				sDTPickerComp += "<div class='dtpicker-compButton increment'>" + dtPickerObj.settings.incrementButtonContent + "</div>";
				sDTPickerComp += "<input type='text' class='dtpicker-compValue'></input>";
				sDTPickerComp += "<div class='dtpicker-compButton decrement'>" + dtPickerObj.settings.decrementButtonContent + "</div>";
				sDTPickerComp += "</div>";
				sDTPickerComp += "</div>";
			}
